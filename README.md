...
- **AI Smart Log**: Type out your day in natural language (e.g., _"I drove 15km to work and ate a beef burger"_). The **Gemini API** instantly parses your activities and quantifies their carbon impact.
...
1. **Initial attempt**: _"Parse this text and tell me the carbon footprint."_ (Resulted in unpredictable text formats).
